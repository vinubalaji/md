 ...
 ************************/
// screen onload
screen_EABD_onLoad = j_81_onLoad = function() {
    createSpinner("files/resources/lib/jquerymobile/images/ajax-loader.gif");
    Tiggr.__registerComponent('mobilepanel7', new Tiggr.BaseComponent({
        id: 'mobilepanel7',
        context: '#j_84'
    }));
    ...
    Tiggr.__registerComponent('mobilebutton15', new Tiggr.BaseComponent({
        id: 'mobilebutton15',
        context: '#j_84'
    }));
...
screen_EABD_windowEvents = j_81_windowEvents = function() {
    $('#j_81').bind('pageshow orientationchange', function() {
        adjustContentHeightWithPadding();
    });
}
// screen elements extra js
screen_EABD_elementsExtraJS = j_81_elementsExtraJS = function() {
    // screen (screen-EABD) extra code
}
// screen elements handler
screen_EABD_elementsEvents = j_81_elementsEvents = function() {
    $("a :input,a a,a fieldset label").live({
        click: function(event) {
            event.stopPropagation();
        }
    });
    $('#j_84 [name="mobilepanel7"]').die().live({
        vclick: function() {
    ...
    $('#j_84 [name="mobilebutton15"]').die().live({
        vclick: function() {
            if (!$(this).attr('disabled')) {
...
$("body").undelegate("pagebeforeshow").delegate("#j_81", "pagebeforeshow", function(event, ui) {
    j_81_onLoad();
});