...
/**
 * Locates Tiggr components by id. Accepts a string containing id of the component to find.
 * 
 * @param {String} componentId - id of the component to find
 * @returns {Array} set of DOM elements representing Tiggr component in the view
 * 
 * @example
